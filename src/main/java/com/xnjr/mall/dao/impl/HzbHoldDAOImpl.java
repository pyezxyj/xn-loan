...
public class HzbHoldDAOImpl extends AMybatisTemplate implements IHzbHoldDAO {
	...
	public HzbHold select(HzbHold condition) {
		return super.select(NAMESPACE.concat("select_hzbHold"), condition,HzbHold.class);
	}


	@Override
	public Long selectTotalCount(HzbHold condition) {
		return super.selectTotalCount(NAMESPACE.concat("select_hzbHold_count"),condition);
	}


	@Override
	public List<HzbHold> selectList(HzbHold condition) {
		return super.selectList(NAMESPACE.concat("select_hzbHold"), condition,HzbHold.class);
	}


	@Override
	public List<HzbHold> selectList(HzbHold condition, int start, int count) {
		return super.selectList(NAMESPACE.concat("select_hzbHold"), start, count,condition, HzbHold.class);
	}
