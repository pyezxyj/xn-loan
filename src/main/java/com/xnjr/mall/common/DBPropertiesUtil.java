...
public class DBPropertiesUtil {
    ...
    public static final class Config {
        ...
        // 短信组件biz地址
        public static String SMS_URL = sysConfigAO
            .getConfigValue("SMS_URL", "");
        ...
        // 账户模块biz地址
        public static String ACCOUNT_URL = sysConfigAO.getConfigValue(
            "ACCOUNT_URL", "");

        // 账户数据库名称
        public static String ACCOUNT_DB = sysConfigAO.getConfigValue(
            "ACCOUNT_DB", "");

        // 用户数据库名称
        public static String USER_DB = sysConfigAO
            .getConfigValue("USER_DB", "");
