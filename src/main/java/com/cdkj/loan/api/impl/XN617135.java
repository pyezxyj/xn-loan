...
import com.cdkj.loan.dto.req.XN617135Req;
 ...
 * @history:
 */
public class XN617135 extends AProcessor {
    private ISYSDictAO sysDictAO = SpringContextHolder
        .getBean(ISYSDictAO.class);

    private XN617135Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN617135Req.class);
    }
