...
import com.cdkj.loan.dto.req.XN617131Req;
 ...
 * @history:
 */
public class XN617131 extends AProcessor {
    private ISYSDictAO sysDictAO = SpringContextHolder
        .getBean(ISYSDictAO.class);

    private XN617131Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN617131Req.class);
